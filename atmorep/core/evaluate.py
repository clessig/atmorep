...
if __name__ == '__main__':
  ...
  mode, options = 'global_forecast', { 
                                      #'dates' : [[2021, 2, 10, 12]]
                                      'dates' : [
                                         [2020, 1, 10, 12] , [2020, 1, 11, 0], [2020, 1, 11, 12], [2020, 1, 12, 0], #[2021, 1, 12, 12], [2021, 1, 13, 0], 
                                         [2020, 4, 10, 12], [2020, 4, 11, 0], [2020, 4, 11, 12], [2020, 4, 12, 0], #[2021, 4, 12, 12], [2021, 4, 13, 0], 
                                         
                                         [2020, 7, 10, 12], [2020, 7, 11, 0], [2020, 7, 11, 12], [2020, 7, 12, 0], #[2021, 7, 12, 12], [2021, 7, 13, 0], 
                                         [2020, 10, 10, 12], [2020, 10, 11, 0], [2020, 10, 11, 12], #[2021, 10, 12, 0], [2021, 10, 12, 12], [2021, 10, 13, 0]
                                       ], 
                                      'token_overlap' : [0, 0],
  ...
  file_path = "/p/scratch/atmo-rep/data/era5_1deg/months/era5_y1979_2021_res025_chunk8.zarr/"  
