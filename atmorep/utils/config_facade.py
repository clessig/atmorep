...
class ConfigFacade(AtmorepConfig):
    ...
    def __init__(self, user_config: config.UserConfig, wandb_id: str):
        ...
        self.num_sample_validate: int = self.training.samples_validation
        ...
        self.with_cls: bool = self.with_cls
        self.with_mixed_precision: bool = self.with_mixed_precision
        self.with_layernorm: bool = self.with_layernorm
        ...
        self.decoder_num_layers: int = self.decoder_num_layers
        self.decoder_num_heads: int = self.decoder_num_heads
        self.decoder_num_mlp_layers: int = self.decoder_num_mlp_layers
        self.decoder_self_att: bool = self.decoder_self_att
        ...
        self.optimizer_zero: bool = self.optimizer_zero
